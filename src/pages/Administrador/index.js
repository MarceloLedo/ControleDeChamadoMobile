    ...
    <>
        <View style={styles.container}>
            <View style={styles.containerButton}>
                <TouchableOpacity style={styles.button} onPress={() => props.navigation.navigate('ListarSetor')}>
                    <Text style={styles.buttonText}>SETOR</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.button} onPress={() => props.navigation.navigate('ListarFuncionario')}>
                    <Text style={styles.buttonText}>FUNCIONARIO</Text>
                </TouchableOpacity>
            </View>
            <View>
